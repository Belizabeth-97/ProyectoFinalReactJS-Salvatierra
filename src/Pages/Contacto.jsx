            ...
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                ...
                <form noValidate className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                    <label className="block">
                        ...
                        <input type="text" placeholder="Leroy Jenkins" className="block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75" />
                    </label>
                    <label className="block">
                        <span className="mb-1">
                    ...
                    <button type="button" className=" text-stone-700 self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 ">
                        Entregar
                    </button>
                </form>
            </div>
